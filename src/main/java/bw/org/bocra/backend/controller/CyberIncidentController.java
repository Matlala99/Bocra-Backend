...
public class CyberIncidentController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> logIncident(@Valid @RequestBody CyberIncident incident) {
        CyberIncident saved = cyberIncidentService.reportIncident(incident);
